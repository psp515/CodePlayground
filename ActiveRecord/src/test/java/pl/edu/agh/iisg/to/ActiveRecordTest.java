...
public class ActiveRecordTest {
    ...
    @Test
    public void createStudentTest() throws SQLException {
        // When
    ...
    @Test
    public void findStudentTest() throws SQLException {
        // When
    ...
    @Test
    public void findStudentIndexTest() throws SQLException {
        // When
    ...
    @Test
    public void enrollStudentTest() throws SQLException {
        // When
    ...
    @Test
    public void courseStudentListTest() throws SQLException {
        // When
    ...
    @Test
    public void cachedCourseStudentListTest() throws SQLException {
        // When
        var student1 = Student.create("Adam", "Paciaciak", 800125);
        var student2 = Student.create("Jan", "Paciaciak", 800126);
        var course = Course.create("WDI");
    ...
    @Test
    public void gradeStudentTest() throws SQLException {
        // When
    ...
    public void createReportTest() throws SQLException {
        ...
        var grade1 = report.get(course1.get());
        var grade2 = report.get(course2.get());

        assertEquals(Float.compare(4.5f, grade1), 0);
        assertEquals(Float.compare(4.0f, grade2), 0);
    }
